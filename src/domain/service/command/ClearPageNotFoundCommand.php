...
class ClearPageNotFoundCommand implements Command
{
    /**
     * @var DatabaseCleaner
     */
    ...
    {
        $range = CommandUserConfig::getRangeByKey('PP_PAGE_NOT_FOUND_TABLE_CLEANER');

        $amount = $this->output->cleanPageNotFoundTable($range);
